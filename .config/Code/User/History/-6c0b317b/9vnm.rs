...
pub fn current_battery() -> f64 {
    ...
    let current_now:f64 = current_now_micro as f64 / 10000000 as f64;
    return current_now;
}

pub fn voltage_max_battery() -> f64{
    let max_voltage_micro: i64 = files::read_int("/sys/class/power_supply/lego-ev3-battery/current_now");
...
pub fn voltage_battery() -> f64 {
    ...
    let voltage_now:f64 = voltage_now_micro as f64 / 10000000 as f64;
    return voltage_now;
}