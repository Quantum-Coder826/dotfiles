...
- `0x8000` to `0xFFFF` is ROM where the program code will be stored the region of memory is **read only**. The layout off words is wierd in the region off memory due to the opcodes being only a single nibble most 
