...
|`7`|`0111`|`7`|JMP|JMP Rx|Jump to the address stored in the specified register, stores the current program counter value in R7 to act as return
|`8`|`1000`|`8`|JEZ|JEZ Rx, Rx|Jump to the address in the second opcode if the value in the first register is zero
|`9`|`1001`|`9`|JNZ|JNZ Rx, Rx|Jump to the address in the second opcode if the value in the first register is not zero
|`A`|`1010`|`10`|RET|RET|Set the program counter to the value found in R7 
