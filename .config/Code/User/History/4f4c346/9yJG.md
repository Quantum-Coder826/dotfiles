...
- `0x0014` to `0x001D` reserved for nothing so can be used as 5 words of just general general puroose memory
- `0x001E` to `0x001F` contains the Stack Pointer.
- `0x0020` to `0x00FF` contains the stack total of 112 16-bit words
