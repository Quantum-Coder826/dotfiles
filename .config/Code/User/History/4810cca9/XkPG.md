...
This is optional but it is useful that if the minecraft chrashes that it will auto restart and that your server will automaticly start after the machine it is running on has booted up.
```bash
