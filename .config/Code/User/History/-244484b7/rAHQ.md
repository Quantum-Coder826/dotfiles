...
Reading 1-bit registers will retun `0b0000000x` where x is the 1-bit value contained in the register. Anything written to bit zero will be applied to the flag, any other bits will be lost.
