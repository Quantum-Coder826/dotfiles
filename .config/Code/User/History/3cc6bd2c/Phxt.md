...
## Memory
Their are a total of 100 memory addresses numbered from 0 to 99. Each address can contain a 3 digit value (from 000 to 999). The data stored can be interpreted as data or instructions.
