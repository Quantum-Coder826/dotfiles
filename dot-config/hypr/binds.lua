...
hl.define_submap("resize", function()
  ...
  hl.bind(Mod .. " + J", hl.dsp.window.resize({ x = 0, y = -20, relative = true }))
  hl.bind(Mod .. " + K", hl.dsp.window.resize({ x = 0, y = 20, relative = true }))
  hl.bind(Mod .. " + L", hl.dsp.window.resize({ x = 20, y = 0, relative = true }))

  -- layout.scrolling specific
  hl.bind(Mod .. " + SHIFT + H", hl.dsp.layout("colresize -0.02"))
  hl.bind(Mod .. " + SHIFT + L", hl.dsp.layout("colresize +0.02"))
  hl.bind(Mod .. " + Q", hl.dsp.layout("colresize +conf"))
  hl.bind(Mod .. " + SHIFT + Q", hl.dsp.layout("colresize -conf"))
